  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.wifi_off, color: Colors.red[900], size: 15.0),
          const SizedBox(width: 5.0),
          Text(message, style: context.text.labelMedium!.copyWith(color: Colors.red[900])),
        ],
      ),
    );
  }
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('No Internet', style: context.text.titleLarge),
                            Text(
                              ...
                              style: context.text.bodyLarge!.copyWith(color: Colors.grey[600]),
